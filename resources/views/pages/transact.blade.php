                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/transactions">
                                ...
                                <div class="form-group"><label class="small mb-1" for="inputPhone">Mpesa Phone</label><input class="form-control" id="inputPhone" type="text" placeholder="e.g. 254722000000" name="phone" value="{{ Auth::user()->phone }}" required/></div>
